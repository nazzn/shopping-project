...
const navigation = [
  ...
  { name: "Products", href: "/api/products", current: false },
      ...
      <Disclosure as="nav" className="bg-pink-600">
        <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
          <div className="relative flex h-16 items-center justify-between">
            ...
            rounded-md p-2 text-gray-200 hover:bg-gray-100 hover:text-white 
            focus:outline-none 
            ...
            >
              ...
              <Menu as="div" className="relative ml-3">
                ...
                <MenuItems
                 ...
                 rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 transition focus:outline-none data-[closed]:scale-95 data-[closed]:transform data-[closed]:opacity-0 data-[enter]:duration-100 data-[leave]:duration-75 data-[enter]:ease-out data-[leave]:ease-in"
                >
                  <MenuItem>
                    <a
                      href="#"
